...
type ComplexityRoot struct {
	Message struct {
		...
		TestMessage func(childComplexity int) int
...
type SubscriptionResolver interface {
	MessageAdded(ctx context.Context) (<-chan *Message, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Message.testMessage":
		if e.complexity.Message.TestMessage == nil {
			break
		}

		return e.complexity.Message.TestMessage(childComplexity), true
...
func (ec *executionContext) _Message_testMessage(ctx context.Context, field graphql.CollectedField, obj *Message) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Mutation_post(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*Message)
	fc.Result = res
	return ec.marshalNMessage2ᚖdebug_gqlgenᚋgraphqlᚐMessage(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Subscription_messageAdded(ctx context.Context, field graphql.CollectedField) (ret func() graphql.Marshaler) {
	...
	return func() graphql.Marshaler {
		...
		return graphql.WriterFunc(func(w io.Writer) {
			...
			w.Write([]byte{':'})
			ec.marshalNMessage2ᚖdebug_gqlgenᚋgraphqlᚐMessage(ctx, field.Selections, res).MarshalGQL(w)
			w.Write([]byte{'}'})
		})
	}
}
...
func (ec *executionContext) _Message(ctx context.Context, sel ast.SelectionSet, obj *Message) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "testMessage":
			out.Values[i] = ec._Message_testMessage(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		default:
...
func (ec *executionContext) marshalNMessage2debug_gqlgenᚋgraphqlᚐMessage(ctx context.Context, sel ast.SelectionSet, v Message) graphql.Marshaler {
	return ec._Message(ctx, sel, &v)
}

func (ec *executionContext) marshalNMessage2ᚖdebug_gqlgenᚋgraphqlᚐMessage(ctx context.Context, sel ast.SelectionSet, v *Message) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
